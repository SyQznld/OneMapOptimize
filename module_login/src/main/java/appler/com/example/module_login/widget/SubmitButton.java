package appler.com.example.module_login.widget;
...
import appler.com.example.module_login.R;
...
public class SubmitButton extends View {
    ...
    public SubmitButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        buttonColor = typedArray.getColor(R.styleable.SubmitButton_buttonColor, Color.parseColor("#ffffff"));
        succeedColor = typedArray.getColor(R.styleable.SubmitButton_succeedColor, Color.parseColor("#81c784"));
        failedColor = typedArray.getColor(R.styleable.SubmitButton_failedColor, Color.parseColor("#e57373"));

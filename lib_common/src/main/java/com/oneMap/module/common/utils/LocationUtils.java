...
public class LocationUtils {
     ...
     * 定位基本设置
     */
    public String initGpsSetting(Activity activity, WebView webView) {
...
//        return false;
        ...
        lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 1000, 5, new LocationListener() {
            ...
            public void onProviderEnabled(String provider) {
                ...
                lnglat = updateShow(lm.getLastKnownLocation(provider), webView);
            }

            @Override
            public void onProviderDisabled(String provider) {
                lnglat = updateShow(null, webView);
            }
        });
        return lnglat;
    }
    ...
    //定义一个更新显示的方法
    public String updateShow(Location location, WebView mMWebView) {

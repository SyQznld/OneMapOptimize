...
abstract class VerticalBar extends View {
    ...
    private double mProgressPercent = 100;
...
//    private int PROGRESS_BAR_COLOR = Color.parseColor("#058AC5"),
//            PROGRESS_BACKGROUND_COLOR = Color.parseColor("#058AC5"),
//            THUMB_COLOR =  Color.parseColor("#058AC5");
    ...
    private void init() {
        ...
        progressBackgroundPaint.setStrokeWidth(5);
        progressBackgroundPaint.setColor(PROGRESS_BACKGROUND_COLOR);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        //float left, float top, float right, float bottom, Paint paint     绘制矩形 各个参数
        ...
        //draw ending arc    float cx(圆心x坐标), float cy(圆心y坐标), float radius(圆半径), Paint paint
        ...
        if (showThumb) {
            ...
            Log.d("Tamal", "dyCircle = " + String.valueOf(dyCircle) + " progress =" + String.valueOf(progress) + " mProgressPercent=" + mProgressPercent);
